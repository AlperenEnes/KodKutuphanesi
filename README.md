...
* **Search & Filter**: Quickly find the snippet you need.
* **Favorites**: Save your most-used codes for instant access.

## Built With
This project is a desktop application built using the following technologies:
* **[Electron.js](https://www.electronjs.org/)** - The desktop framework used.
* **[Node.js](https://nodejs.org/)** - The JavaScript runtime environment.
* **[Chromium](https://www.chromium.org/)** - The engine powering the UI.
